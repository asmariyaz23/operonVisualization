...
def main():
    ...
    # Step 8: Run the visualization pipelilne using the pairwaise event matrix that is calculated in step 7
    
    # This input will need to be altered to explicity take in the file created in 7... but for now the default will do.
#    cmd8 = "./operonVisual.py -n ./optimized_operon/ -m ./mapping.csv -t ./out_tree.nwk -e ./event_dict.p -o ./visualization"
    cmd8 = "./gbeerVisual/operonVisual.py -n ./gbeerVisual/data/optimized_operon/ -m ./gbeerVisual/data/mapping.csv -t ./gbeerVisual/data/reorder.nwk -e./gbeerVisual/data/event_dict.p -o ./visual"
    print "cmd8", cmd8
    os.system(cmd8)
